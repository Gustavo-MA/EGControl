...
int Llanta1=12, LLanta2=13, LLanta3=15, LLanta4=14;
...
if (String(topic) == "Control/Mqtt/Motor") { 

    if(messageTemp=="Up") //Camina hacia adelante
    {
        digitalWrite(Llanta1,HIGH);
        digitalWrite(Llanta2,HIGH);
        digitalWrite(Llanta3,LOW);
        digitalWrite(Llanta4,LOW);
        
    }
    /*else if(messageTemp=="Down") //Camina hacia atras ***  Checar polaridad* y proponer modelo de 2 llantas y un volante para las llantas delanteras.
   {
        digitalWrite(Llanta1,LOW);
        digitalWrite(Llanta2,LOW);
        digitalWrite(Llanta3,HIGH);
        digitalWrite(Llanta4,HIGH);
        
    }*/

    esle                    // El carrito esta parado
   {
        digitalWrite(Llanta1,LOW);
        digitalWrite(Llanta2,LOW);
        digitalWrite(Llanta3,LOW);
...
void EnvioMensaje()
{
  Serial.println(json); // Se imprime en monitor solo para poder visualizar que el string esta correctamente creado
    ...
    client.publish("Control/Mqtt/Motor", char_array); 
 }
...
void reconnect() {
  ...
  while (!client.connected()) { // Pregunta si hay conexión
    ...
    if (client.connect("ESP32CAMClient")) { //Pregunta por el resultado del intento de conexión
      ...
      client.subscribe("Control/Mqtt/Motor"); // Esta función realiza la suscripción al tema
